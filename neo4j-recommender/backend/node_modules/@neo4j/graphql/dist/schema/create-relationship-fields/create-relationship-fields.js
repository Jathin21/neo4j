    ...
    relationshipFields.forEach((rel) => {
        ...
        if (nestedOperations.has(constants_1.RelationshipNestedOperationsOption.CONNECT) &&
            ...
            schemaComposer.getOrCreateITC(connectName, (tc) => {
                ...
                if (nodeHasRelationshipWithNestedOperation(node, constants_1.RelationshipNestedOperationsOption.CONNECT)) {
                    tc.addFields({
                ...
                tc.addFields({ overwrite: overwrite_1.overwrite });
        ...
        if (nestedOperations.has(constants_1.RelationshipNestedOperationsOption.DELETE) && nodeFieldUpdateInput) {
            ...
            if (!schemaComposer.has(nodeFieldDeleteInputName)) {
                schemaComposer.getOrCreateITC(nodeFieldDeleteInputName, (tc) => {
                    ...
                    if (nodeHasRelationshipWithNestedOperation(node, constants_1.RelationshipNestedOperationsOption.DELETE)) {
        ...
        if (nestedOperations.has(constants_1.RelationshipNestedOperationsOption.DISCONNECT) && nodeFieldUpdateInput) {
            ...
            if (!schemaComposer.has(nodeFieldDisconnectInputName)) {
                schemaComposer.getOrCreateITC(nodeFieldDisconnectInputName, (tc) => {
                    tc.addFields({ where: `${rel.connectionPrefix}${upperFieldName}ConnectionWhere` });
                    if (nodeHasRelationshipWithNestedOperation(node, constants_1.RelationshipNestedOperationsOption.DISCONNECT)) {
...
function nodeHasRelationshipWithNestedOperation(node, nestedOperation) {
